...
public class CategoryPage {
    ...
    public static final Target BTN_CONFIRM_CATEGORY = Target.the("Button to confirm the new category").locatedBy("//android.widget.FrameLayout/android.view.ViewGroup/android.widget.ImageButton");
